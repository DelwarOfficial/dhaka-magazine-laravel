...
<?php if( isset($tickerHeadlines) && count($tickerHeadlines) > 0 ): ?>
    ...
    <div class="dms-ticker-bar"
        ...
        <div id="dmsTickerTrack"
            ...
            <div id="dmsTickerContent"
                ...
                <?php $__currentLoopData = $tickerHeadlines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $headline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('article.show', $headline['slug'])); ?>"
                       class="dms-ticker-link"
                       style="color:var(--color-fg,#1f2a44);font-size:16px;font-weight:500;text-decoration:none;white-space:nowrap;padding:0 4px;transition:color .2s;"><?php echo e($headline['title']); ?></a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\websie\dhaka-magazine-laravel\resources\views/components/dhaka-magazine-scroll/scroll-nav.blade.php ENDPATH**/ ?>