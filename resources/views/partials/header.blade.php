<header class="w-full bg-bg flex flex-col font-serif dark:bg-surface" id="site-header">
  ...
  <div class="w-full max-w-screen-xl mx-auto px-4 py-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-3 md:gap-4">
        ...
        {{-- Date + E-paper (stacked, right aligned) --}}
  ...
  <div id="site-nav" class="w-full bg-[#1d2640] text-white sticky top-0 z-40">
    <div class="w-full max-w-screen-xl mx-auto px-4">
      ...
      {{-- Mobile Sticky Bar — visible only on mobile inside the sticky nav --}}
      <div class="md:hidden flex items-center justify-between h-[48px] w-full gap-2 overflow-hidden">
        ...
        <div class="mobile-nav-scroll-wrapper flex-1" style="overflow-x:auto;overflow-y:hidden;-webkit-overflow-scrolling:touch;scrollbar-width:none;">
          <div style="display:flex;align-items:center;gap:0;white-space:nowrap;padding-bottom:0px;">
            ...
            <a href="{{ route('category.show', 'জাতীয়') }}" class="mobile-scroll-nav-item">বাংলাদেশ</a>
            <a href="{{ route('category.show', 'রাজনীতি') }}" class="mobile-scroll-nav-item">রাজনীতি</a>
            <a href="{{ route('category.show', 'অর্থনীতি') }}" class="mobile-scroll-nav-item">অর্থনীতি</a>
            <a href="{{ route('category.show', 'বিশ্ব') }}" class="mobile-scroll-nav-item">আন্তর্জাতিক</a>
            <a href="{{ route('category.show', 'বিনোদন') }}" class="mobile-scroll-nav-item">বিনোদন</a>
            <a href="{{ route('category.show', 'খেলা') }}" class="mobile-scroll-nav-item">খেলাধুলা</a>
            <a href="{{ route('category.show', 'চাকরি') }}" class="mobile-scroll-nav-item">চাকরি</a>
            <a href="{{ route('category.show', 'লাইফস্টাইল') }}" class="mobile-scroll-nav-item">জীবনযাপন</a>
            <a href="{{ route('category.show', 'ভিডিও') }}" class="mobile-scroll-nav-item">ভিডিও</a>
            <a href="{{ route('category.show', 'তথ্য-প্রযুক্তি') }}" class="mobile-scroll-nav-item">প্রযুক্তি</a>
          </div>
        </div>
