  ...
  <div class="w-full max-w-screen-xl mx-auto px-4 pt-12 pb-6">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
      ...
      <div class="col-span-1">
        <a href="{{ route('home') }}" class="block mb-6" aria-label="Dhaka Magazine">
          <img src="{{ asset('images/dhaka-magazine-white-logo.svg') }}" class="h-8 w-auto opacity-90 hover:opacity-100 transition-opacity" alt="Dhaka Magazine" />
        </a>
